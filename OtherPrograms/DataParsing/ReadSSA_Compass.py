...
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+.dz',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+.dz',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0.dz',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+leading.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ leading (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+leading.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+leading.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ leading (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+leading.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.pi+leading.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers pi+ leading (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.pi+leading.dz',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+leading.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ leading (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+leading.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+leading.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ leading (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+leading.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k+leading.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k+ leading (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k+leading.dz',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0leading.dx',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 leading (differential in x)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0leading.dx',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0leading.dpt',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 leading (differential in pt)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0leading.dpt',"SIDIS")
...
print("Done.  =>     Create points & append to data set ...")
DataCurrentSiv=DataProcessor.DataSet.DataSet('compass.sivers.k0leading.dz',"SIDIS")
DataCurrentSiv.comment="COMPASS SSA-Sivers k0 leading (differential in z)"
DataCurrentSiv.reference="0802.2160"
DataCurrentCol=DataProcessor.DataSet.DataSet('compass.collins.k0leading.dz',"SIDIS")
