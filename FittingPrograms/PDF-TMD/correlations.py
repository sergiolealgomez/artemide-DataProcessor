...
runName="model2.2_"+PDFinUse+"_correlation_"
...
#####################
def CorrelationParameters(pN,pMin,pMax):
    import copy
    Npoints=25
    vectorO=[]
    vectorF1=[]
    ...
    n1=0
    n2=0
    ## compute xSec for each of parameters (ranging equidistantly in range)
...
#################################################
p0=CorrelationParameters(1,0.0001,0.1)

p1=CorrelationParameters(2,initialValues[2]*0.33,initialValues[2]*3.)
p2=CorrelationParameters(3,initialValues[3]*0.33,initialValues[3]*3.)

p3=CorrelationParameters(4,initialValues[4]*0.33,initialValues[4]*3.)
p4=CorrelationParameters(5,initialValues[5]*0.33,initialValues[5]*3.)

p5=CorrelationParameters(6,initialValues[6]*0.33,initialValues[6]*3.)
p6=CorrelationParameters(7,initialValues[7]*0.33,initialValues[7]*3.)

p7=CorrelationParameters(8,50.,2000.)
